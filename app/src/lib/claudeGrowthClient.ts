...
- Если раздел входных данных недостаточен (sufficientData: false, пустой formatBreakdown, demandSignal.available: false) — явно скажи об этом в соответствующей части ответа, не додумывай.
